...
const routes: Routes = [
  ...
  {path: 'book-details/:bookId', component: BookDetailsComponent, canActivate:[AuthGuard], data:{roles:['Admin','BIBLIOTHECAIRE']}},
  ...
  {path: 'borrow-book', component: BorrowBookComponent, canActivate:[AuthGuard], data:{roles:['Admin','User','BIBLIOTHECAIRE','ADHERENT']}},
  {path: 'return-book', component: ReturnBookComponent, canActivate:[AuthGuard], data:{roles:['Admin','User','BIBLIOTHECAIRE','ADHERENT']}},
  {path: 'reservations', component: ReservationsComponent, canActivate:[AuthGuard], data:{roles:['Admin','User','BIBLIOTHECAIRE','ADHERENT']}},
